...
export interface GatewayOsd {
  ...
  wireless_link?: {
    ...
    '4g_link_state'?: boolean,
    '4g_quality'?: number,
    '4g_uav_quality'?: number,
    dongle_number?: number,
    link_workmode?: number,
    sdr_freq_band?: number,
    sdr_link_state?: boolean,
    sdr_quality?: number,
  },
  transmission_signal_quality?: number,
}
...
export interface DeviceOsd {
  ...
  night_lights_state?: NightLightsStateEnum;
  height_limit?: number;
  distance_limit_status?: DistanceLimitStatus;
...
export interface DockBasicOsd {
  ...
  mode_code: number,
  cover_state: number,
  supplement_light_state: boolean,
  emergency_stop_state: boolean,
  air_conditioner?: {
    switch_state: number,
    mode_code: number,
  }
  battery_store_mode?: BatteryStoreModeEnum;
  alarm_state?: boolean;
  putter_state: number,
  sub_device?: {
    device_sn?: string,
